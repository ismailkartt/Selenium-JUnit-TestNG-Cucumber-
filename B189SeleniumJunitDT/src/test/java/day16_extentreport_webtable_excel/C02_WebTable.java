...
public class C02_WebTable extends TestBase {
    ...
    3 <tobdy> bu tag webtable daki datalarin yogun olarak bulundugu kısımdırb <tr> satirlari ve
      <td> bu satirlardaki her bir hücreyi temsil eder
     */
    ...
    public void webTableTest() {
        ...
        WebElement thirdRow = driver.findElement(By.xpath("//table[1]//tr[3]"));
