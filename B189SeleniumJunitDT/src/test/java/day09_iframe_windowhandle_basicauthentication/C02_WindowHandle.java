...
public class C02_WindowHandle extends TestBase {
 ...
 /*
    Eger bir sayfaya gittikten sonra yeni sekme yada yeni bir pencere acmak istersek bunun icin
      driver.switchTo().newWindow() methodunu kullanmaliyiz
    bu method parantez icinde yeni acilacak olan sayfananin bir sekmemi yoksa
     bir yeni penceremi oldugunu asagidaki kodlar ile yapabiliriz
